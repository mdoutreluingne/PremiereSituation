...
namespace JR.Utils.GUI.Forms
{
    ...
    */
    public class FlexibleMessageBox
    {
        ...
        /// <param name="buttons">The buttons.</param>
        /// <returns>The dialog result.</returns>
        public static System.Windows.Forms.DialogResult Show(System.Windows.Forms.IWin32Window owner, string text, string caption, MessageBoxButtons buttons)
        {
        ...
        /// <param name="icon">The icon.</param>
        /// <returns>The dialog result.</returns>
        public static System.Windows.Forms.DialogResult Show(System.Windows.Forms.IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
        ...
        /// <param name="defaultButton">The default button.</param>
        /// <returns>The dialog result.</returns>
        public static System.Windows.Forms.DialogResult Show(System.Windows.Forms.IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private System.Windows.Forms.MessageBoxDefaultButton defaultButton;
            ...
            /// <param name="owner">The owner.</param>
            private static void SetDialogStartPosition(FlexibleMessageBoxForm flexibleMessageBoxForm, System.Windows.Forms.IWin32Window owner)
            {
                //If no owner given: Center on current screen
                if (owner == null)
                {
                    var screen = Screen.FromPoint(Cursor.Position);
                    flexibleMessageBoxForm.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            ...
            private static void SetDialogIcon(FlexibleMessageBoxForm flexibleMessageBoxForm, System.Windows.Forms.MessageBoxIcon icon)
            {
                switch (icon)
                {
            ...
            /// <param name="buttons">The buttons.</param>
            /// <param name="defaultButton">The default button.</param>
            private static void SetDialogButtons(FlexibleMessageBoxForm flexibleMessageBoxForm, MessageBoxButtons buttons, System.Windows.Forms.MessageBoxDefaultButton defaultButton)
            {
