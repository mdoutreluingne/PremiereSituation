...
namespace CoucheModele.modele
{
    public class daoTransaction
    {
        ...
        {
            this.dbal.execRequete("INSERT INTO transaction (date, montant, type, numero, commentaire, reservation_id, client_id) VALUES ('" + transaction.Date.ToString("yyyy-MM-dd HH:mm tt") + "', " + transaction.Montant + ", '" + transaction.Type + "', '" + transaction.Numero + "', '" + transaction.Commentaire + "', " + transaction.Reservation_id + ", " + transaction.Client_id + ");");
        }
